...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer51686 && ($this->initializer51686->__invoke($valueHoldere4d21, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer51686) || 1) && $this->valueHoldere4d21 = $valueHoldere4d21;

        if ($this->valueHoldere4d21 === $returnValue = $this->valueHoldere4d21->paginate($target, $page, $limit, $options)) {
            return $this;
        }
