 ...
 */
class getInstallPermRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InstallPermRepository' shared autowired service.
     *
     * @return \App\Repository\InstallPermRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InstallPermRepository.php';

        return $container->privates['App\\Repository\\InstallPermRepository'] = new \App\Repository\InstallPermRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
