 ...
 */
class getClientGrantsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ClientGrantsRepository' shared autowired service.
     *
     * @return \App\Repository\ClientGrantsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ClientGrantsRepository.php';

        return $container->privates['App\\Repository\\ClientGrantsRepository'] = new \App\Repository\ClientGrantsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
