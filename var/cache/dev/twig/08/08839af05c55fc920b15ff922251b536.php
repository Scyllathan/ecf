...
class __TwigTemplate_e7bbd5fb67a1211d0e14ecf095c2046c extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"col-12\">
        ...
        echo "                </div>
                <div class=\"col d-flex justify-content-end\">
                    <a href=\"";
        // line 35
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_more_about", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["client"]) || array_key_exists("client", $context) ? $context["client"] : (function () { throw new RuntimeError('Variable "client" does not exist.', 35, $this->source); })()), "id", [], "any", false, false, false, 35)]), "html", null, true);
    ...
    {
        return array (  118 => 35,  114 => 33,  105 => 29,  101 => 27,  95 => 25,  93 => 24,  86 => 20,  77 => 16,  73 => 15,  69 => 14,  65 => 12,  59 => 10,  52 => 7,  50 => 6,  43 => 1,);
    }
        ...
        <div class=\"bg-light yellow-border rounded my-2 my-sm-3 p-3\">
            <div class=\"row\">
                ...
                <div class=\"col mb-2\">
                    ...
                    <p class=\"mb-1\"><b>{{ client.name }}</b></p>
