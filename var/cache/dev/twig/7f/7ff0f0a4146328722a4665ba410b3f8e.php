...
class __TwigTemplate_ce74659042a5594199e30f3897c5ead3 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "</p>
                    ...
                    <div class=\"row\">
                        <div>
                            <hr/>
                            <h2 class=\"mb-1 h5\"><b>Contacts</b> :</h2>
                            <ul>
                                <li><u>DPO</u> : ";
        // line 41
        ...
        echo "</li>
                    ...
                    <div class=\"row\">
                        <div>
                            <hr/>
                            <h2 class=\"mb-1 h5\"><b>Structures</b> :</h2>
                            <ul>
                                ";
        // line 52
                ...
                <div class=\"bg-light yellow-border rounded my-2 my-sm-3 p-3\">
                    <div class=\"row\">
                        ...
                        <div class=\"col\">
                            ...
                            <h1 class=\"mb-1 h4\"><b>{{ client.name }}</b></h1>
                        ...
                        <div>
                            ...
                            <ul>
                                {% for branch in client.branches %}
                                    <li><b>{{ branch.name }} - Identifiant : {{ branch.id }}</b></li>
                                    <ul>
