...
/* base.html.twig */
class __TwigTemplate_4dbf93d2f8673b8fb471a87e5883ea3e extends Template
{
    private $source;
    private $macros = [];
...
<html>
    <head>
        ...
        // line 9
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("css/global.scss"), "html", null, true);
        echo "\">
        ";
        // line 10
    ...
    ";
        ...
        echo "    ";
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 25, $this->source); })()), "flashes", [0 => "alert"], "method", false, false, false, 25));
        foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
            // line 26
...
", "base.html.twig", "C:\\xampp\\apps\\ecf\\templates\\base.html.twig");
    }
}
