...
class __TwigTemplate_262a22241fb84e78a05daf1e80e89d24 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["client"]) || array_key_exists("client", $context) ? $context["client"] : (function () { throw new RuntimeError('Variable "client" does not exist.', 1, $this->source); })()), "active", [], "any", false, false, false, 1)) {
            echo "active";
        }
        echo "\">
    ...
    {
        return array (  126 => 38,  120 => 35,  116 => 34,  112 => 33,  105 => 28,  101 => 27,  97 => 26,  89 => 20,  87 => 19,  83 => 18,  79 => 17,  75 => 16,  70 => 13,  64 => 11,  57 => 8,  55 => 7,  43 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("<div class=\"col-12 col-lg-6 client {% if client.active %}active{% endif %}\">
    <div class=\"bg-light yellow-border rounded my-2 my-sm-3 px-1 py-2 p-sm-2 h-25 d-flex
                                flex-column
                                justify-content-between\">
        <div class=\"row\">
